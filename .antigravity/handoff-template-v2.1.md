...
> ✅ Versão 2.1 — Corrigido (duplicação removida) + Checksum automático
...
2. Salve este handoff no caminho obrigatório:
   ...
   ```
   Exemplo: `.antigravity/handoffs/CICLO-2026-04-24-001-backend-handoff.md`
...
**Especialista:** [backend / frontend / security-arch / security-code / qa / devops / ui-review / product / auditor / discovery / prd-validator / tech-decision / spec-enricher / sprint-planner / sprint-validator / sprint-evaluator]
...
| Checksum válido? | [ ] Sim / [ ] Não | Orquestrador (auto) |
...
## 📎 Checksum Automático (Gerado pelo Orquestrador)
...
handoff_checksum:
  versao: "2.1"
  campos_obrigatorios:
    - especialista: "enum[product,backend,frontend,ui-review,security-arch,security-code,qa,devops,auditor,discovery,prd-validator,tech-decision,spec-enricher,sprint-planner,sprint-validator,sprint-evaluator]"
