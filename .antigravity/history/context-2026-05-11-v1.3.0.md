...
meta:
  versao: "1.3.0"
  ultima_atualizacao: "2026-05-11T12:00:00Z"
  atualizado_por: "orchestrator"
  ciclo_atual: "CICLO-2026-05-11-FASE0"
  sessao_ativa: "closed"  # "none" | "active" | "closed"
  checksum: "sha256:..."
---
...
```yaml
metricas_ciclo:
  ciclo_id: "CICLO-2026-05-11-FASE0"
  inicio: "2026-05-11T11:50:00Z"
  fim: "2026-05-11T12:05:00Z"
  duracao_minutos: "15"
  especialistas_atuados: "3"
  findings:
    critico: "0"
    alto: "0"
    medio: "0"
    baixo: "3"
  taxa_aprovacao_auditor: "APROVADO"
  tokens_estimados: "5000"
  retrabalhos: "0"
  regressoes_detectadas: "não"
  divergencias_api: "0"
```
...
decisoes:
  - id: "DEC-2026-05-11-1"
    titulo: "Remoção Tippy.js e event delegation XSS"
    tomada_por: "frontend"
    data: "2026-05-11T12:00:00Z"
    raciocinio: "Mitigar risco de XSS removendo onclick inline e melhorar performance removendo biblioteca de tooltip não utilizada."
    afeta: ["frontend", "qa"]
    status: "ativa"
    pode_mudar: true
    condicao_mudanca: "Se novos tooltips complexos forem necessários, reinstalar Tippy.js."
    revisada_em: null
    revisada_por: null
    motivo_revisao: null
...
ciclo_atual:
  id: "CICLO-2026-05-11-FASE0"
  iniciado_por: "humano"
  objetivo: "Fase 0 - Correção de 5 bugs críticos apontados no ROADMAP.md"
  especialistas_envolvidos:
    - orchestrator: "concluido"
    - frontend: "concluido"
    - qa: "concluido"
    - devops: "concluido"
    - auditor: "concluido"
  bloqueios_ativos: []
  proximos_passos:
    - "Iniciar Fase 1 (Design System shadcn-style)"
...
|------|-------------|-------------|-------------------|----------------|
| 2026-05-11 | frontend | Adicionado event delegation e retirado Tippy.js | Correção de vulnerabilidade e performance (Fase 0) | Sim (QA/Auditor) |
