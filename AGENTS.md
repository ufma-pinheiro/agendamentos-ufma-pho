# AGENTS.md — ECC + RTK + Graphify Stack

> **Versão:** 1.0  
> **Stack:** Everything Codex (ECC) + Redux Toolkit (RTK) + Graphify  
> **Uso:** Cole este arquivo na raiz do projeto ou em `~/.Codex/AGENTS.md` para instruções de contexto persistente.

---

## 1. Visão Geral da Stack

Esta stack combina três camadas para maximizar produtividade e minimizar consumo de tokens no Codex:

| Camada | Ferramenta | Função |
|--------|-----------|--------|
| **Orquestração** | ECC (Everything Codex) | Sistema de agents, skills, hooks e regras de segurança |
...
└── Codex-plugin.json         # manifesto do plugin ECC
```
...
*Gerado para uso no Codex. Atualize conforme a evolução do projeto.*
